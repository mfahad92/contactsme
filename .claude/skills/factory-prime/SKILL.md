---
name: factory-prime
description: Orient yourself in this codebase before planning anything. The read-only first step of the factory's own loop.
argument-hint: the issue you are about to work, e.g. `gh:issue:12` or a path to a written brief
---
